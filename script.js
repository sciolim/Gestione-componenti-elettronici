...
function init() {
    ...
    popolaDropdown("cmbTipo", [
        "Amplificatore operazionale", "Diodo", "Transistor", "Resistore", 
        "Condensatore", "Induttore", "Microcontrollore", "Regolatore di tensione", 
        "Convertitore DC-DC", "LED", "Fotodiodo", "Optoisolatore", "Relè", 
        "Trasformatore", "Fusibile", "Interruttore", "Connettore", "Cristallo oscillatore", 
        "Sensore di temperatura", "Sensore di pressione", "Sensore di movimento", 
        "Memoria Flash", "Memoria RAM", "Memoria EEPROM", "ADC (Convertitore analogico-digitale)", 
        "DAC (Convertitore digitale-analogico)", "Timer", "Comparatore di tensione", 
        "MOSFET", "LED", "Circuiti integrati logici", "Circuiti integrati di potenza", 
        "Circuiti integrati di segnale", "Circuiti integrati di interfaccia", "Circuiti integrati di comunicazione"
    ]);
